...
ifeq (${OS}, Windows_NT)
	g++ -o hw5 mainParser.o variable.o atom.o number.o struct.o list.o term.o -lgtest
else
	g++ -o hw5 mainParser.o variable.o atom.o number.o struct.o list.o term.o -lgtest -lpthread
endif
